...
th_data = pd.read_csv("TH_DATA_GROUPED.csv",header=0, usecols=header)
...
expanded_th = expanded_th.drop_duplicates(subset=['PermitNum','Clean_Addresses'])
...
final = final.drop_duplicates(subset=['PermitNum','Clean_Addresses'])
