...
To run the program:
    -Navigate in the terminal to the project folder's directory on your computer
    -Run:
        - "python -m RunROIClassifier" on Windows
        - "python3 -m RunROIClassifier" on Mac/Linux
